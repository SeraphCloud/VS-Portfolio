...
const Contact = () => {
	...
	return (
		<Section id="contact" title="Vamos Trabalhar Juntos?">
			<div className="contact-content">
				<p>
					Estou em busca da minha primeira oportunidade profissional como
					desenvolvedor front-end, back-end ou full-stack. Se você tem uma vaga
					ou projeto em mente, ficarei feliz em conversar!
				</p>
				...
				<div className="contact-links">
					...
					<a
						href="https://linkedin.com/in/victor-alexandre-silva"
						target="_blank"
						rel="noopener noreferrer"
						title="LinkedIn"
					...
					<a
						href="mailto:alexandre.victor2641@gmail.com"
						title="Email"
